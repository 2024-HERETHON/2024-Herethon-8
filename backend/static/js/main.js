...
const contents = [
    {
        first: {
            ...
            author: "책쟁이",
            imgSrc: "../../static/img/실시간인기도서1.png",
            link: "movie.html",
        },
        second: {
            ...
            title: "해리 포터와 마법의 돌",
            author: "조앤 K. 롤링",
            imgSrc: "../../static/img/실시간인기도서2.png",
            link: "magic.html",
        },
    },
    {
        first: {
            ...
            title: "호빗: 뜻밖의 여정",
            author: "J.R.R. 톨킨",
            imgSrc: "../../static/img/실시간인기도서3.png",
            link: "adventure.html",
        },
        second: {
            intro: "다른 세계로의 초대",
            title: "나니아 연대기",
            author: "C.S. 루이스",
            imgSrc: "../../static/img/실시간인기도서4.png",
            link: "narnia.html",
        },
    },
    {
        first: {
            ...
            title: "작가가 전하는 삶의 의미",
            author: "김작가",
            imgSrc: "../../static/img/실시간인기도서5.png",
            link: "life.html",
        },
        second: {
            intro: "영혼의 울림을 찾다",
            title: "영혼을 울리는 책",
            author: "박작가",
            imgSrc: "../../static/img/실시간인기도서6.png",
            link: "soul.html",
        },
    },
];
...
const writerContents = [
    {
        first: {
            imgSrc: "../../static/img/작가프로필3.png",
            name: "김문학",
            category: "#문학 #역사",
            intro: "우리나라의 문학과 역사에 깊은 관심을 가지고 연구 중 입니다. 수많은 국내 문학 작품을 통해 여러...",
        },
        second: {
            imgSrc: "../../static/img/작가프로필4.png",
            name: "이기술",
            category: "#기술 #혁신",
            intro: "4차 산업 혁명에 맞는 AI 기술 혁신을 통해 세상을 바꾸고자 합니다. 다양한 기술 프로젝트를 통해...",
        },
    },
    {
        first: {
            imgSrc: "../../static/img/작가프로필5.png",
            name: "박철학",
            category: "#철학 #예술",
            intro: "철학적 사유와 예술적 감성을 결합한 작품을 창작하고 있습니다. 독자들과 소통하기 위해 강연하고...",
        },
        second: {
            imgSrc: "../../static/img/작가프로필6.png",
            name: "최문학",
            category: "#문학 #과학",
            intro: "문학과 과학의 융합을 추구하는 작가입니다. 새로운 시도를 위해 현재 대학원에 진학 중이며...",
        },
    },
    {
        first: {
            imgSrc: "../../static/img/작가프로필7.png",
            name: "정예술",
            category: "#예술 #디자인",
            intro: "예술과 디자인의 경계를 넘나들며 창의적인 작품을 만듭니다. 여러 전시회를 통해 제 작품을 보실...",
        },
        second: {
            imgSrc: "../../static/img/작가프로필8.png",
            name: "한기술",
            category: "#기술 #환경",
            intro: "환경 친화적인 기술 개발에 매진하고 있습니다. 지속 가능한 미래를 위해 우리 모두가 실천할...",
        },
    },
];
